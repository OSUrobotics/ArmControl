...
int main(int argc, char** argv)
{
    ...
    tf2::Quaternion quat;
    //quat.setRPY(0*PI/180, 90*PI/180, 0*PI/180); 
    ...
    geometry_msgs::Pose start1 = control.plan_in_xyzw(0.5,  0, 0.04, quat , start);
    ...
    geometry_msgs::Pose start3 = control.plan_in_xyzw(start1.position.x+0.15, start1.position.y, start1.position.z, quat, start1, 15);
